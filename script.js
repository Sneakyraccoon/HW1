...
document.addEventListener("DOMContentLoaded", () => {
  ...
  startDateInput.addEventListener("change", function () {
    ...
    localStorage.setItem("weekActive", "true");
  ...
  endDateInput.addEventListener("change", function () {
    localStorage.setItem("monthActive", "true");
  ...
  if (localStorage.getItem("weekActive") === "true") {
    weekButton.disabled = false;
    setPeriod("week");
  } else if (localStorage.getItem("monthActive") === "true") {
    monthButton.disabled = false;
    setPeriod("month");
  }
...
function checkAllConditions(
  ...
  console.log("UNIT", unitsChecked, "DAYS", daysChecked);
